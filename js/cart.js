...
if ("basket" in localStorage && JSON.parse(localStorage.getItem('basket')).length > 0) {
        ...
        $("#basket").append(`<div class="divBasket"> 
                                ...
                                <p id='quantity-${shopping.code}'>${shopping.quantity}</p>
                                    <div class="buttonsBasket">
                                        <button id="${shopping.code}" class="btn btn-add">+</button>
                                        <button id="${shopping.code}" class="btn btn-sub">-</button>
    ...
    text.innerHTML = `<h3>El carrito está vacío</h3>
                    <a  href="../index.html"><button class="backHome">Volver</button></a>`
...
$(".purchase").click(function () {
    ...
    divBasket.innerHTML = '';
    let text = document.createElement('div');
    text.innerHTML = `<h2>El carrito está vacío</h2>
                        <a href="../index.html"><button class="backHome">Volver</button></a>`
    divBasket.appendChild(text)
